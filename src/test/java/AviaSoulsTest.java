...
public class AviaSoulsTest {
    ...
    Ticket ticket1 = new Ticket("Москва", "Казань", 30000, 8, 15);
    Ticket ticket2 = new Ticket("Москва", "Санкт-Петербург", 30000, 12, 21);
    Ticket ticket3 = new Ticket("Москва", "Пермь", 5000, 20, 22);
    Ticket ticket4 = new Ticket("Москва", "Нижний Новгород", 3000, 17, 18);
    Ticket ticket5 = new Ticket("Москва", "Париж", 7000, 3, 7);
    Ticket ticket6 = new Ticket("Москва", "Пермь", 9000, 10, 13);
    Ticket ticket7 = new Ticket("Москва", "Пермь", 6000, 19, 21);
    ...
    public void testTest6() {
        Ticket[] expected = {};
        Ticket[] actual = manager.search("Амстердам", "Тилбург");
    ...
    public void testTest7() {
        ...
        Ticket[] expected = {ticket3, ticket7, ticket6};
        Ticket[] actual = manager.searchAndSortBy("Москва", "Пермь", comparator);
